...
- [Coding4Hours/Coding4Hours](https://github.com/Coding4Hours/Coding4Hours) - This repo has 3 stars and 0 forks🌟
...
- [Harsh-bin/dotfold](https://github.com/Harsh-bin/dotfold) - Over-enginnered password-protected "TUI + CLI" tool to hide folders in linux by prefixing them with ( . ) , changes ownership to root and securely stores folder metadata using OpenSSL and a SHA-256 ha

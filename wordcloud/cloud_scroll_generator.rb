...
class CloudScrollGenerator
  ...
  def previous_cloud_url
    "https://github.com/Coding4Hours/Coding4Hours/blob/master/previous_clouds/#{CloudTypes::CLOUDLABELS[-2]}_cloud#{CloudTypes::CLOUDLABELS.size - 1}.png"
  end
